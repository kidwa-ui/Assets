...
export const COA: Record<string, Account> = {
  ...
  "1230": { name: "กองทุนสำรองเลี้ยงชีพ (PVD)", type: "asset", normal: "debit", subtype: "invest" },
  "1240": { name: "ประกันสังคม-สะสม",     type: "asset",    normal: "debit",  subtype: "invest"  },
  ...
  "2240": { name: "เงินกู้สวัสดิการ-สหกรณ์ออมทรัพย์", type: "liability", normal: "credit", subtype: "noncurrent" },
  "2250": { name: "เงินกู้สวัสดิการบ้าน (บริษัท)",     type: "liability", normal: "credit", subtype: "noncurrent" },
  "2260": { name: "เงินกู้สวัสดิการรถ (บริษัท)",       type: "liability", normal: "credit", subtype: "noncurrent" },
  "2270": { name: "เงินกู้สวัสดิการอื่นๆ",            type: "liability", normal: "credit", subtype: "noncurrent" },
  "2310": { name: "รายได้ PVD รอการรับรู้",  type: "liability", normal: "credit", subtype: "noncurrent" },
  ...
  "4150": { name: "รายได้สมทบจากนายจ้าง", type: "income",   normal: "credit" },
  ...
  "4450": { name: "รายได้จาก PVD",       type: "income",   normal: "credit" },
  ...
  "5002": { name: "🛒 วัตถุดิบ / อุปโภค-บริโภค",  type: "expense",  normal: "debit"  },
  "5003": { name: "⛽ เติมน้ำมัน",               type: "expense",  normal: "debit"  },
  "5004": { name: "🚗 ค่าเดินทาง / จอดรถ / ทางด่วน", type: "expense", normal: "debit" },
  "5005": { name: "🏋️ ออกกำลังกาย / สปา / อาหารเสริม", type: "expense", normal: "debit" },
  "5006": { name: "🏥 ค่าแพทย์ / ยา",           type: "expense",  normal: "debit"  },
  "5007": { name: "👕 เสื้อผ้า / แฟชั่น",       type: "expense",  normal: "debit"  },
  "5008": { name: "📱 โทรศัพท์ / อินเทอร์เน็ต", type: "expense",  normal: "debit"  },
  "5009": { name: "💡 สาธารณูปโภค / โทรศัพท์ / อินเตอร์เน็ต", type: "expense", normal: "debit" },
  "5010": { name: "🎬 บันเทิง / เกม / Subscribe", type: "expense",  normal: "debit"  },
  ...
  "5016": { name: "👨‍👩‍👧 โอนเงินให้คนอื่น / ค่าเลี้ยงดู", type: "expense",  normal: "debit"  },
  "5017": { name: "🛡️ ประกันชีวิต / ประกันสุขภาพ",    type: "expense",  normal: "debit"  },
  "5018": { name: "🔑 ค่าเช่าบ้าน / หอพัก",           type: "expense",  normal: "debit"  },
  "5019": { name: "🔧 ค่าซ่อมรถ / ประกันรถ / ภาษีรถ", type: "expense",  normal: "debit"  },
  "5020": { name: "👶 ค่าใช้จ่ายลูก / เรียนพิเศษ",    type: "expense",  normal: "debit"  },
  "5021": { name: "💼 ค่าใช้จ่ายธุรกิจ",              type: "expense",  normal: "debit"  },
  "5030": { name: "🧾 ภาษีเงินได้บุคคลธรรมดา",       type: "expense",  normal: "debit"  },
  "5031": { name: "🧾 ภาษีหัก ณ ที่จ่าย (ดอกเบี้ย/ปันผล)", type: "expense", normal: "debit" },
  "5032": { name: "🏠 ภาษีที่ดินและสิ่งปลูกสร้าง",   type: "expense",  normal: "debit"  },
  "5033": { name: "🚗 ภาษีรถยนต์ประจำปี",            type: "expense",  normal: "debit"  },
  "5034": { name: "📛 ภาษีป้าย",                     type: "expense",  normal: "debit"  },
  "5035": { name: "💵 ภาษีมูลค่าเพิ่ม (VAT)",        type: "expense",  normal: "debit"  },
  "5036": { name: "🏢 ภาษีธุรกิจเฉพาะ",              type: "expense",  normal: "debit"  },
  "5037": { name: "📋 อากรแสตมป์",                   type: "expense",  normal: "debit"  },
  "5039": { name: "🧾 ภาษีและค่าธรรมเนียมอื่นๆ",     type: "expense",  normal: "debit"  },
