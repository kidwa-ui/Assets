...
export const SCENARIOS: Scenario[] = [
  ...
  { id: "exp_grocery",  group: "💸 ค่าใช้จ่าย",   label: "🛒 ของชำ / ซูเปอร์มาร์เก็ต",          dr: "5002", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_fuel",     group: "💸 ค่าใช้จ่าย",   label: "⛽ เติมน้ำมัน / ค่าเชื้อเพลิง",        dr: "5003", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_transit",  group: "💸 ค่าใช้จ่าย",   label: "🚗 ค่าเดินทาง / Grab / BTS / MRT",     dr: "5004", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_fitness",  group: "💸 ค่าใช้จ่าย",   label: "🏋️ ฟิตเนส / ออกกำลังกาย / สปา",      dr: "5005", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_health",   group: "💸 ค่าใช้จ่าย",   label: "🏥 สุขภาพ / ค่าแพทย์ / ยา",           dr: "5006", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_fashion",  group: "💸 ค่าใช้จ่าย",   label: "👕 เสื้อผ้า / แฟชั่น / รองเท้า",      dr: "5007", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_telecom",  group: "💸 ค่าใช้จ่าย",   label: "📱 ค่าโทรศัพท์ / อินเทอร์เน็ต",       dr: "5008", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_utility",  group: "💸 ค่าใช้จ่าย",   label: "💡 ค่าสาธารณูปโภค (ไฟ / น้ำ / แก๊ส)", dr: "5009", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
