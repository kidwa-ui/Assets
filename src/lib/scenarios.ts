...
export const SCENARIOS: Scenario[] = [
  ...
  // ค่าใช้จ่าย
  { id: "exp_food",     group: "💸 ค่าใช้จ่าย",   label: "🍜 ค่าอาหาร / ร้านอาหาร",            dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_grocery",  group: "💸 ค่าใช้จ่าย",   label: "🛒 ของชำ / ซูเปอร์มาร์เก็ต",          dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_fuel",     group: "💸 ค่าใช้จ่าย",   label: "⛽ เติมน้ำมัน / ค่าเชื้อเพลิง",        dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_transit",  group: "💸 ค่าใช้จ่าย",   label: "🚗 ค่าเดินทาง / Grab / BTS / MRT",     dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_fitness",  group: "💸 ค่าใช้จ่าย",   label: "🏋️ ฟิตเนส / ออกกำลังกาย / สปา",      dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_health",   group: "💸 ค่าใช้จ่าย",   label: "🏥 สุขภาพ / ค่าแพทย์ / ยา",           dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_fashion",  group: "💸 ค่าใช้จ่าย",   label: "👕 เสื้อผ้า / แฟชั่น / รองเท้า",      dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_telecom",  group: "💸 ค่าใช้จ่าย",   label: "📱 ค่าโทรศัพท์ / อินเทอร์เน็ต",       dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_utility",  group: "💸 ค่าใช้จ่าย",   label: "💡 ค่าสาธารณูปโภค (ไฟ / น้ำ / แก๊ส)", dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_entertain",group: "💸 ค่าใช้จ่าย",   label: "🎬 บันเทิง / สตรีมมิ่ง / ภาพยนตร์",   dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_travel",   group: "💸 ค่าใช้จ่าย",   label: "✈️ ท่องเที่ยว / ที่พัก / โรงแรม",     dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_home",     group: "💸 ค่าใช้จ่าย",   label: "🏠 ของใช้ในบ้าน / ซ่อมแซม / เฟอร์นิเจอร์", dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_edu",      group: "💸 ค่าใช้จ่าย",   label: "📚 การศึกษา / คอร์สออนไลน์ / หนังสือ", dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_pet",      group: "💸 ค่าใช้จ่าย",   label: "🐶 สัตว์เลี้ยง",                       dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
  { id: "exp_gift",     group: "💸 ค่าใช้จ่าย",   label: "🎁 ของขวัญ / บริจาค / ทำบุญ",          dr: "5000", cr: "PM", pmRole: "pay", pmLabel: "ช่องทางที่จ่ายเงิน" },
